...
val img: Img[UnsignedShortType] = new ArrayImgFactory[UnsignedShortType](Array[Long](10L, 10L, 10L), new UnsignedShortType)
```
...
![Hero image](/images/trianglify.png){.full-width}
